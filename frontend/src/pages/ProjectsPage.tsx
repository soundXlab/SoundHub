...
import { Settings2, TrendingUp, Users, Clock, Loader, Folder } from "lucide-react";
              ...
              {loading ? (
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: spacing.lg }}>
                  {projects.map((p) => (
                    ...
                    >
                      <CardContent>
                        <div style={{ padding: spacing.lg, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                          <div>
                            <CardTitle>
                              <div style={{
                                fontSize: typography.fontSize.h3,
